...
import com.oms.model.CoreEntity;
import com.oms.service.AbstractService;
...
public abstract class AbstractController<T extends CoreEntity> implements Serializable {
  ...
  public T getRandomObjectFromList(List<T> inputList){
    return inputList.get(getRandomIndex(inputList.size()));
  }
